    ...
    public sealed class LocaleUK : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionGroupLocaleID(PCSettings.kAboutDiagnosticsGroup), "Діагностика" },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(PCSettings.Scope)),
                    ...
                    "**Деякі дороги вже не дозволяють вуличне паркування, наприклад автомагістралі та асиметричні 3-смугові дороги.**"
                },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(PCSettings.EnforcementStatus)),
                    "<Припарковано> = авто, які ще стоять на вулицях, де вибраний режим забороняє паркування.\n" +
                    "<Смуги> = ділянки паркування вздовж дороги, де стоять ці авто. Одна смуга може вміщати багато авто.\n" +
                    "<Вимкнено> = смуги вуличного паркування, закриті для нових авто.\n" +
                    "<за районами> показує:\n" +
                    ...
                    "<Нові або перебудовані дороги> можуть ненадовго прийняти кілька авто, поки оновлюються їхні смуги. " +
                    "Уже припарковані авто виїдуть, коли містяни ними скористаються.\n" +
                    "<ПЕРЕВ.> = деякі вибрані дороги ще не заблоковані. Запустіть місто ненадовго й перевірте знову. " +
                    "Якщо <ПЕРЕВ.> не зникає, додайте звіт про паркування, коли звертаєтеся по допомогу." },
