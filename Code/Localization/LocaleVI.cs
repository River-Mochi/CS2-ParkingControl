    ...
    public sealed class LocaleVI : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(PCSettings.ShowInstructions)), "Hiện cách sử dụng chế độ <Theo khu vực>.\nTẮT = tắt các hạn chế toàn thành phố và theo khu vực, phần lớn trở về hành vi mặc định của game.\n- Tuy nhiên, bạn vẫn có thể dùng nút <Cấm đỗ xe> cho từng đoạn đường và lệnh cấm đó vẫn có hiệu lực.\nToàn thành phố = chặn đỗ xe ven đường đủ điều kiện trên toàn thành phố." },
